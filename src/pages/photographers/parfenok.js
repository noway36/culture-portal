...
class Parfenok extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            about:
                'Белорусский фотограф, куратор выставочных проектов, руководитель галереи визуальных искусств «NOVA»[1]. Живёт и работает в Минске. В творческой фотографии с середины 1980-х гг. Фотографии обучался в студии Валерия Лобко. Участвовал в многочисленных выставочных проектах в Беларуси и за рубежом. Создатель и куратор проектов галереи «NOVA». В фотографии — сторонник аналоговых технологий и ручной печати.',
